...
const Home = () => {
  ...
  const filteredProduct = products.filter((products) => {
    ...
    //verifica se a categoria da variavel de estado (front) é igual a do banco de dados
    //CRIA UM NOVO ARRAY
  });
  ...
  return (
    <div className="md:w-[737px mx-auto w-full px-3 text-white md:px-0">
      ...
      <p className="mt-2 mb-2 font-bold text-[#F2DAAC] uppercase">
        {" "}
        {category}
      </p>
